...
//additionalQuestions
  ...
  $childrenBirthDate = $request['childrenBirthDate'];
  $childrenBirthPlace = $request['childrenBirthPlace'];
  $childrenEducationalAttainment = $request['childrenEducationalAttainment'];
...
$query = "INSERT FROM tbl_applicant (
	`fld_applicationDate`, 
	`fld_firstName`, 
	`fld_middleName`,
	`fld_lastName`, 
