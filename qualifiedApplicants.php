      ...
      <section id ="examResults" class="section-padding">
         <div class="container">
            <div class="row">
               <div class="header-section text-center">
                  <h2>List of Qualified Applicants for the following Programs:</h2>
         ...
         <div class="container">
               ...
               <?php 
                        ...
                        ?>
                     <div class="row">
                     <h3 style="padding-bottom:10px;"><?php echo $fld_programName; ?></h3>
                     <table class="program table table-striped table-bordered dataTable" style="width: 100%; float: left; border: 1;" border="1" cellpadding="5">
                        <thead>
                           <tr>
                              <th style="width: 10.3204%;">&nbsp;Applicant ID:</th>
                              <th style="width: 60.6796%;">&nbsp;Name:</th>
                           </tr>
                        </thead>
                        <tbody>
                           <?php
                              $programid = $fld_programID;
                              $getQualifier  = $home->readAllQualifier2($programid);
