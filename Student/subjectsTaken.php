...
<div class="page animsition">
   <div class="page-header">
      <h1 class="page-title">My Subjects Taken</h1>
      <ol class="breadcrumb">
         <li><a href="../index.html">Home</a></li>
         <li class="active">Subjects Taken</li>
      </ol>
   </div>
            ...
            <div class="row row-lg">
               <div class="col-sm-12">
                  ...
                  <div class="example-wrap">
                     <h4 class="example-title">My Subjects Taken</h4>
...
<script type="text/javascript">
 $(document).ready(function(){
       var getfunctionName = "populateMyGrades";
