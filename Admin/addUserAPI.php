...
// die();
	...
	if(mysqli_num_rows($result)>=1){
		...
		$query = "INSERT INTO tbl_users(Username, passwordPlain, passwordSalt, staffId, accessType, status) VALUES ('$userName', '$password', '$salt', '$generatedId', '$accessType', '$statusUser')";
		$test = mysqli_query($conn, $query);
		$queryStaff = "INSERT INTO tbl_staffs(staffId, firstName, middleName, lastName, emailAddress, employmentType, maxUnits, availableSchedule) VALUES ('$generatedId', '$firstName', '$middleName', '$lastName', '$emailAddress', '$employmentType', '$maxUnits', '$schedule')";
