		...
		<tr>
			<td colspan="1">
				...
				<?php } ?>
	                ...
	                <a href="cancelApplicant.php?id=<?php echo $_GET['id'] ?>" style="color: white"><button class="btn btn-danger pull-right">Cancel</button></a>
	                <a href="approvedApplicant.php?id=<?php echo $_GET['id'] ?>" style="color: white"><button class="btn btn-primary pull-right"> Approve</button></a>
	                 <a href="../Admin/applicantList.php"><button class="btn btn-success pull-right">View more applicant</button></a>
	            </div>
	        </div>
	    </div>
	</div>
