        ...
        <div class="tab-pane active" id="subject" role="tabpanel">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" name="firstName" id="Firstname" value=" <?php echo $userStaff['middleName']; ?>" disabled />
                </div>
                <div class="col-sm-4">
                  <label>Lastname</label>
                  <input type="text" class="form-control" name="firstName" id="Firstname" value="<?php echo $userStaff['lastName']; ?>" disabled />
                </div>
                <div class="col-sm-4">
