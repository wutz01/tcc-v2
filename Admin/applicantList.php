                            ...
                            ?>
                              <tr>
                                 ...
                                 <td><a href="applicantProfile.php?id=<?php echo $fld_applicantID; ?>">
                                  <button class="btn btn-success" onclick="viewDetails()" type="submit" id="viewDetails">View Details</button></a> <a href="approvedApplicant.php?id=<?php echo $fld_applicantID; ?>" style="color: white"><button class="btn btn-primary">Approve</button></a>
                                  <a href="cancelApplicant.php?id=<?php echo $fld_applicantID; ?>" style="color: white"><button class="btn btn-danger">Cancel</button></a></td>
                              </tr>
                              <?php
                                }
                              ?>
