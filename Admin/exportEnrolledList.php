...
$pdf->SetTitle('List of Enrolled Students | TCC');
...
$html ='<table id="exportpdf" width = "100%" style = "font-family:Arial;" border = "0" cellpadding = "2" cellspacing = "0">';
					$html .='<tr>';
					$html .= '<th style = "font-size:20px;background-color:#736F6E;font-weight:bold;">LIST OF ENROLLED STUDENT</th>';
					$html .='</tr>';
			...
			$html .='</table><br><br>';
               ...
               $html .='<table border="1" width="100%" style="font-family: Arial; font-size:13px;" cellpadding="2">';
                  $html .='<tr align="center">';
                     ...
                     $html .='<td width="20%"><span>STUDENT NO</span></td>';
                     $html .='<td width="40%"><span>STUDENT NAME</span></td>';
